...
def obs2text_v1(obs, action_template):
    ...
    if in_kitchen:
        if pancake_in_microwave:
            ...
            object_text += "You see pancake and microwave here. "
        ...
        if hold_pancake:
            ...
            if close_to_pancake and not close_to_microwave:
                object_text += "The pancake is close to you. The microwave is not close to you. "
                action_list = [0, 2, 3, 5, 6]
            elif close_to_microwave and not close_to_pancake:
                object_text += "The microwave is close to you. The pancake is not close to you. "
                action_list = [0, 2, 3, 4, 8, 9]
            elif not close_to_pancake and not close_to_microwave:
                object_text += "The pancake and the microwave are not close to you. "
                action_list = [0, 2, 3, 4, 5]
            elif close_to_pancake and close_to_microwave:
                object_text += "The pancake and the microwave are close to you. "
        ...
        if hold_pancake:
            object_text += "The microwave is not available in this room. Currently, you have grabbed the pancake in hand. "
        else:
            object_text += "The microwave is not available in this room. Currently, you are not grabbing anything in hand. "
        action_list = [0, 1, 3]
    elif in_bedroom:
        if hold_pancake:
            object_text += "The microwave is not available in this room. Currently, you have grabbed the pancake in hand. "
...
def obs2text_v2(obs, action_template):
    ...
    if in_kitchen:
        if see_chips and see_milk:
            object_text += "and see chips and milk. "
            ...
            object_text += "and only see chips. "
            if hold_chips:
        ...
        object_text += "and you see a coffee table, a TV and a sofa. "
